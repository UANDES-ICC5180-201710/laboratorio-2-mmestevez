...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { course: @inscription.course, student: @inscription.student } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { course: @inscription.course, student: @inscription.student } }
